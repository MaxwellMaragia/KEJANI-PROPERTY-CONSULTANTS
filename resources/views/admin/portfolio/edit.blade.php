        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ route('portfolios.update',$portfolio->id) }}" method="post"
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-offset-3 col-md-6">
                                ...
                                <div class="form-group text-center">
                                    <img src="{{ Storage::url($portfolio->media) }}" alt="User Image" id="preview"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="slug" name="title" placeholder="title"
                                           required="required" value="{{ $portfolio->title }}">
                                </div>
