            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('downloads.update',$download->id) }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('PATCH') }}
                            <div class="box-body">
                                ...
                                <div class="col-md-offset-3 col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="slug">Select new file</label>
                                        <input type="file" name="file" class="form-control">
                                    </div>

                                    <div class="form-group">
                                        <label for="slug">File type</label>
                                        <input type="text" class="form-control" id="slug" name="file_type" placeholder="eg Application, document e.t.c" required="required" value="{{ $download->file_type }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="slug">Title</label>
                                        <input type="text" class="form-control" id="slug" name="title" placeholder="Main title" required="required" value="{{ $download->title }}">
                                    </div>
