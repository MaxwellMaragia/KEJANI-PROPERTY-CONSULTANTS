...
class SettingsController extends Controller
{
    ...
    public function index()
    {
            ...
            return view('admin.settings.setting',compact('logo_dark','footer_text','facebook','logo_light','favicon','email','whatsapp','instagram','mobile','github','custom_css','address','map'));
